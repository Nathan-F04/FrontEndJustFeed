    ...
    <div className={classes.mainDiv} onClick={() => props.toggleMenuHide()}> 
      <div className={classes.thePopup}>
        <div className={classes.sideLink}>
          ...
          <span className={classes.sidebarFinalItem}><IoMdSettings className={classes.sidebarIcon}/><div className={classes.gap}></div><Link href="/bank-info" >Settings</Link></span>
        </div>
      </div>
    </div>
  )
